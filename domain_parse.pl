...
########## straight from ncbi (and it works!) 
########## Usage perl ./domain_parse.pl <Input file of Gi accession numbers>
...
open STDOUT, '>',"domain.parse.out" or die $!;    
print $response->content,"\n";
    
    #system("grep \"specific\" domain.parse.out > domain.parse.log"); 
    #system("grep \"superfamily\" domain.parse.out >> domain.parse.log"); 
#    system("grep \"multi-dom\" domain.parse.out >> domain.parse.log"); 
