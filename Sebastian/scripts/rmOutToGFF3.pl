...
#     Revision 1.1  2008/05/13 23:23:18  rhubley
#       - Adding lots of pre-masked genomes to the database
#
#     Revision 1.1  2008/03/14 21:17:02  rhubley
#       Initial version
#
#
#
...
use lib $FindBin::Bin;
#use lib "$FindBin::Bin/../";
use lib "/opt/biosoft/RepeatMasker-3.2.9";
use Getopt::Long;
use Data::Dumper;
...
for ( my $i = 0 ; $i < $searchResults->size() ; $i++ ) 
{
  ...
  print "RepeatMasker\t";
  if ( $result->getSubjType() ne "Unknown" )
  {
    print $result->getSubjType() . "\t";
  }else 
  {
