...
if (defined($help)) {
	...
	print "Usage:\n";
	print "maker_automatic_annotator_v1.pl -input <FASTA/TXT> -threads <INT> -numseq <INT> -gffprefix <prefix for gff files>  other_options\n";
...
if(defined($force)) {print STDERR "All results will be deleted it before reRun (Blast analysis will need to be redone)\n"; $force = '-force'} else {$force = ''}
...
gffprefix	prefix for gff files
