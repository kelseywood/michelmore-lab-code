...
my @SizeRanges = ('100', '200', '300', '400', '500', '1000', '1500', '2000', '2500', '3000', '3500', '4000', '4500', '5000', '6000', '7000', '8000', '9000', '10000', '15000', '20000');
...
foreach my $size (@sortedSizes) {
	...
	if ($size > 20000) {
		++$sequenceDistr{'20001'}; 
		$amountSequenceDistr{'20001'} += $size;
	} #end if big sequence
...
if(defined($sequenceDistr{'20001'})) {
		print OUTPUT "+20000\t", $sequenceDistr{'20001'}, "\t", $amountSequenceDistr{'20001'}, "\n";
