...
my $ConsGeno1 = 10 + (($ARGV[1]-1)*3);
my $colDepthGeno1 = 11 + (($ARGV[1]-1)*3);
my $AlleleCompGeno1 = 12 + (($ARGV[1]-1)*3);

my $ConsGeno2 = 10 + (($ARGV[2]-1)*3);
my $colDepthGeno2 = 11 + (($ARGV[2]-1)*3);
my $AlleleCompGeno2 = 12 + (($ARGV[2]-1)*3);
...
print NONCOVER "Contig\tPos\tProbeCoverage\tReference\tDepth\tAlleleGeno1\tDepthGeno1\tA:T:G:C\tAlleleGeno2\tDepthGeno2\tA:T:G:C\n";

print SAME "Contig\tPos\tProbeCoverage\tReference\tDepth\tAlleleGeno1\tDepthGeno1\tA:T:G:C\tAlleleGeno2\tDepthGeno2\tA:T:G:C\n";

print SNP "Contig\tPos\tProbeCoverage\tReference\tDepth\tAlleleGeno1\tDepthGeno1\tA:T:G:C\tAlleleGeno2\tDepthGeno2\tA:T:G:C\n";

print HETS "Contig\tPos\tProbeCoverage\tReference\tDepth\tAlleleGeno1\tDepthGeno1\tA:T:G:C\tAlleleGeno2\tDepthGeno2\tA:T:G:C\n";
        		...
        		if ($freqAGeno1 > $alleleFreq || $freqCGeno1 > $alleleFreq || $freqGGeno1 > $alleleFreq || $freqTGeno1 > $alleleFreq) {
                		...
                		if ($freqAGeno2 > $alleleFreq || $freqCGeno2 > $alleleFreq || $freqGGeno2 > $alleleFreq || $freqTGeno2 > $alleleFreq) {
                        		...
                        		if ($alleleGeno1 ne $alleleGeno2) {
                                		...
                                		print SNP $snpData[0], "\t", $snpData[1], "\t", $snpData[2], "\t", $snpData[3], "\t", $depth, "\t", $alleleGeno1, "\t", $depthGeno1, "\t", $snpData[$AlleleCompGeno1], "\t", $alleleGeno2, "\t", $depthGeno2, "\t", $snpData[$AlleleCompGeno2], "\n";

	                                } else {
        	                        	print SAME $snpData[0], "\t", $snpData[1], "\t", $snpData[2], "\t", $snpData[3], "\t", $depth, "\t", $alleleGeno1, "\t", $depthGeno1, "\t", $snpData[$AlleleCompGeno1], "\t", $alleleGeno2, "\t", $depthGeno2, "\t", $snpData[$AlleleCompGeno2], "\n";
                	                } #end else

                        	} else {
                         		print HETS $snpData[0], "\t", $snpData[1], "\t", $snpData[2], "\t", $snpData[3], "\t", $depth, "\t", $alleleGeno1, "\t", $depthGeno1, "\t", $snpData[$AlleleCompGeno1], "\t", $alleleGeno2, "\t", $depthGeno2, "\t", $snpData[$AlleleCompGeno2], "\n";
	                        } #end else
        	 	...
        	 	print NONCOVER $snpData[0], "\t", $snpData[1], "\t", $snpData[2], "\t", $snpData[3], "\t", $depth, "\t", $alleleGeno1, "\t", $depthGeno1, "\t", $snpData[$AlleleCompGeno1], "\t", $alleleGeno2, "\t", $depthGeno2, "\t", $snpData[$AlleleCompGeno2], "\n";
	        } #end else
