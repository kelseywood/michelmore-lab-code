		...
		##################################### RIL IMAGE ###############################################
			if draw_ril_image == "TRUE":
				...
				if trouble > 0 and trouble < 2:
					...
					if cell_size == "LARGE":
						draw_ril.text([(ml+xrn*c+m_map-35+id_shift),(ml+k*c+c/2-5)],fill=(0,60,180),text=(`trouble`),font=font)
				if trouble == 2:
					draw_ril.text([(ml+xrn*c+m_map-160+id_shift),(ml+k*c+c/2-5)],fill=(0,60,180),text=(id),font=font)
					...
					if cell_size == "LARGE":
						draw_ril.text([(ml+xrn*c+m_map-35+id_shift),(ml+k*c+c/2-5)],fill=(125,0,0),text=(`trouble`),font=font)
				if trouble > 2:
					draw_ril.text([(ml+xrn*c+m_map-160+id_shift),(ml+k*c+c/2-5)],fill=(0,60,180),text=(id),font=font)
					...
					if cell_size == "LARGE":
						draw_ril.text([(ml+xrn*c+m_map-35+id_shift),(ml+k*c+c/2-5)],fill=(200,0,0),text=(`trouble`),font=font)
				##############################
		###############################################################################################
		#####################################++<
		k = k + 1
